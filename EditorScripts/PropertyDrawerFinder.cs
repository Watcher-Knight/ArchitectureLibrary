...
namespace ArchitectureLibrary
{
    ...
    public static class PropertyDrawerFinder
    {
        ...
        public static PropertyDrawer Find(SerializedProperty property)
        {
            ...
            {
                customDrawers.Add(pType, Find(pType));
            }
        ...
        public static Type GetPropertyType(SerializedProperty property)
        {
            ...
            FieldInfo fi = parentType.GetField(fullPath[0], BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
            for (int i = 1; i < fullPath.Length; i++)
            {
                fi = fi.FieldType.GetField(fullPath[i], BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance);
            }
            return fi.FieldType;
        }
        ...
        {
            Assembly assem = Assembly.GetAssembly(typeof(PropertyDrawerFinder));
